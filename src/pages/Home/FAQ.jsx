...
const FAQ = () => {
    return (
        <section className="px-4 py-10 text-gray-800 bg-white dark:bg-gray-50">
            <Container>
                <h2 className="text-3xl font-bold text-center mb-10 text-[#25A8D6]">Frequently Asked Questions</h2>
